    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExtensionUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExtensionUsers_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExtensionUsers_Extensions_ExtensionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerVerifications", x => x.Code);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerVerifications_Sessions_SessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CallAnswers_Answers_AnswerId",
                        column: x => x.AnswerId,
                        principalTable: "Answers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CallAnswers_Calls_CallId",
                        column: x => x.CallId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CallAnswers_AnswerId",
                table: "CallAnswers",
                column: "AnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_CallAnswers_CallId",
                table: "CallAnswers",
                column: "CallId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerVerifications_SessionId",
                table: "CustomerVerifications",
                column: "SessionId");

            migrationBuilder.CreateIndex(
                name: "IX_ExtensionUsers_ExtensionId",
                table: "ExtensionUsers",
                column: "ExtensionId");

            migrationBuilder.CreateIndex(
                name: "IX_ExtensionUsers_UsersId",
                table: "ExtensionUsers",
                column: "UsersId");
